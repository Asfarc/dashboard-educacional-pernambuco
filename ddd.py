...
def carregar_dados(modalidade: str):
    ...
    # normaliza códigos (município, escola)
    ...
    if "Etapa agregada" in df.columns:
        # novos arquivos: usam coluna “Etapa agregada” + “Nome da Etapa…” + possivelmente “Ano/Série”
        ...
        df[["Etapa", "Subetapa", "Série"]] = df["Etapa de Ensino"] \
